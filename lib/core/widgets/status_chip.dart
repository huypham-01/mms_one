...
class StatusChip extends StatelessWidget {
  ...
  Color get _resolvedColor {
    ...
    if (lower.contains('approved') || lower.contains('done') || lower.contains('complete')) {
      return AppColors.success;
    }
    if (lower.contains('pending') || lower.contains('waiting') || lower.contains('review')) {
      return AppColors.warning;
    }
    if (lower.contains('rejected') || lower.contains('cancel') || lower.contains('error')) {
      return AppColors.error;
    }
    if (lower.contains('progress') || lower.contains('active') || lower.contains('processing')) {
